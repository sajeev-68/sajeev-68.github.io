...
- The malware, using refelective code loading, was able to run a different process. I managed to dump the file and fix it to make it into a working executable(If you want to know how to properly dump a PE file from memory watch [this]()).
